...
//        c.start(c);
    ...
    public void start(client c) throws SocketException, IOException, ClassNotFoundException {
        ...
        Writer writer = writer = new BufferedWriter(new OutputStreamWriter(
        ...
        while (true) {
            ...
            while (!correctpacket) {
                ...
                newSeqNo = rfsm.eventaction(event, this, seqNo, dataPacket.seqNo, socket, dataPacket, source_IP, source_port);
            ...
            builder.append(new String(dataPacket.data).trim()+" ");

            if (builder.length() > segmentSize) {
